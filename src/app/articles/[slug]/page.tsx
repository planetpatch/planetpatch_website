...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  return (
    <main className="relative overflow-hidden bg-gradient-to-b from-sky-500 to-slate-900 dark:bg-gradient-to-b dark:from-slate-900 dark:to-sky-900 min-h-screen">
      <StarsBackground />
      <article className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-3xl my-16 bg-white/90 dark:bg-slate-900/90 rounded-lg shadow-xl backdrop-blur-md border border-slate-200 dark:border-white/10">
        ...
        {/* Header Title */}
        <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 dark:text-gray-100 mb-4 leading-tight">
          {article.title}
        </h1>
